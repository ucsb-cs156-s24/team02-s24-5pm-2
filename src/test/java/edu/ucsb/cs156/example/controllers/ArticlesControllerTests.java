...
public class ArticlesControllerTests extends ControllerTestCase {
        ...
        public void logged_in_user_can_get_all_articles() throws Exception {
                ...
                LocalDateTime ldt2 = LocalDateTime.parse("2024-04-27T00:00:00");
        ...
        public void an_admin_user_can_post_a_new_article() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/articles/post?title=Article1&url=url1&explanation=explanation1&email=email1&dateAdded=2024-04-27T00:00:00")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                // arrange
                LocalDateTime ldt = LocalDateTime.parse("2024-04-27T00:00:00");
        ...
        public void admin_can_edit_an_existing_article() throws Exception {
                ...
                LocalDateTime ldt1 = LocalDateTime.parse("2023-04-27T00:00:00");
                LocalDateTime ldt2 = LocalDateTime.parse("2024-04-27T00:00:00");
